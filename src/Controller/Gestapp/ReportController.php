...
class ReportController extends AbstractController
{
    ...
    public function PropertyCSV2(PropertyRepository $propertyRepository, PhotoRepository $photoRepository): Response
    {
        $properties = $propertyRepository->reportpropertycsv();
